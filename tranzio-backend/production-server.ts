...
app.get('/api/transactions/my-transactions', authenticateToken, async (req: any, res) => {
  try {
    const userId = req.user.userId;
...
app.get('/api/messages/transactions/:transactionId', authenticateToken, async (req: any, res) => {
  try {
...
app.put('/api/messages/:messageId/read', authenticateToken, async (req: any, res) => {
  try {
